        ...
        <main className="gridpages-main-content">
            <div className="container">
                ...
                <ImageComp array={[
                            ...
                            {id:3, src:Elefant, title:"A majestic creature", owner:"Jacek Janiczak", alt:"Et billede taget helt tæt på en elefants hoved", masonsize:"big"},
                            {id:4, src:Fugl, title:"A puffin starts to fly after running on water", owner:"Mark König", alt:"En søpapegøje der løber hen ad vandet og starter med at flyve", masonsize:"wide"},
                            {id:5, src:Hund, title:"Dog making puppy eyes", owner:"Huzaifa Ginwala", alt:"En trist hund der laver hvalpe øjne", masonsize:"big"},
                            {id:6, src:Kat, title:"My cat named Havuç. Which means Carrot!", owner:"Efe Yagiz Soysal", alt:"En kat, der heller Gulerod, der slapper af i solen", masonsize:"wide"},
                            {id:7, src:Maage, title:"Højt Flyvende", owner:"Philipp Deus", alt:"En flyvende måge", masonsize:"normal"},
